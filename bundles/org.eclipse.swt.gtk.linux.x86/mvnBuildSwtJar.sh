...
# org.eclipse.swt.gtk.linux.x86.source_3.1XX.0.v20XXXXXX-XXXX.jar in the ./target folder
...
if [ "${DEV_ECLIPSE}" != "" ]; then
	...
	cp -v ./target/org.eclipse.swt.gtk.linux.x86-*-SNAPSHOT.jar ${DEV_ECLIPSE}/plugins/org.eclipse.swt.gtk.linux.x86_*
	cp -v ./target/org.eclipse.swt.gtk.linux.x86-*-SNAPSHOT-sources.jar ${DEV_ECLIPSE}/plugins/org.eclipse.swt.gtk.linux.x86.source_*.jar
	echo "Note: Below should list newly generated *jar files with current timestamp"
	ls -l --color=auto -a ${DEV_ECLIPSE}/plugins/org.eclipse.swt.gtk.linux.x86*
else
	echo "Note:" 
